"""Official WarehouseSort metric with the ver2 policy; independent test/final seeds."""
import json
import random
import sys
import time
...
def main(job):
    ...
    try:
        ...
        agent = Observer(load_act(job['checkpoint'], obs, env.single_action_space, device, **job['policy_config']))
